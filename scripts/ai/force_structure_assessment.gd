...
var gold_reserve: Dictionary = {}
var required_gold_savings: int = 0
var gold_pressure: bool = false
var food_growth_budget: int = 0
var baseline_group_count: int = 0
var force_structure_target: int = 0
