...
echo "==> [1/23] 编译检查（headless 导入，捕获脚本错误）"
...
echo "==> [6/23] 国内 ideal field cache 等价门禁"
HOME="$GODOT_HOME" "$GODOT" --headless --path "$PROJECT_DIR" \
