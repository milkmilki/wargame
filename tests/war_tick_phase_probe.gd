...
const AI_STAGES: Array[String] = [
	...
	"ai_snapshot_frontier_scan",
	"ai_snapshot_frontier_threat",
	"ai_snapshot_frontier_threat_score",
	"ai_snapshot_frontier_threat_queries",
	"ai_snapshot_frontier_threat_hits",
	"ai_snapshot_frontier_threat_misses",
	"ai_snapshot_frontier_threat_hit_time",
	"ai_snapshot_frontier_threat_miss_time",
	"ai_snapshot_frontier_concentration",
	"ai_snapshot_frontier_sort",
