...
最新真实地图长跑为 4 种子 × 1095 天，四局均保持 4 国存活，领土变化次数为 `20/11/7/8`。备战次数为 `7/5/8/13`，完成集结后的自然宣战次数为 `4/4/5/3`；每局形成 `1～2` 条长期防御联盟，未冻结战争，四局共触发 31 支额外动员军。最终粮仓总库存为 `7139/7577/6026/6927`，断粮军为 `0/0/1/0`，全部军队有有效命令且 `invalid=0`。
